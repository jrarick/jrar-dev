...
export default function Technologies() {
  ...
  useGSAP(
    () => {
      const rows = gsap.utils.toArray<HTMLDivElement>('.technology-row')
  ...
  return (
    <>
      <h2 className="uppercase text-5xl mb-48 text-center font-mono font-semibold">
        The Tools I Use
      </h2>
      <div className="space-y-20 -rotate-10" ref={containerRef}>
        {Array.from({length: icons.length / 4}, (_, i) => (
          <div
            key={i}
            id={`technology-row-${i}`}
            className="technology-row flex justify-center gap-28"
          >
