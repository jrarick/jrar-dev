...
const styles = tv({
  base: "font-mono bg-app-background forced-colors:bg-[Canvas] shadow-[0_0_20px_var(--color-primary-background)] bg-clip-padding border border-primary-background text-app-accent outline-0",
  variants: {
    isEntering: {
