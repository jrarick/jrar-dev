  ...
  return (
    <AriaColorSlider
      ...
      className={composeTailwindRenderProps(
        props.className,
        "font-mono orientation-horizontal:grid orientation-vertical:flex grid-cols-[1fr_auto] flex-col items-center gap-2 orientation-horizontal:w-56",
      )}
    >
      <Label>{label}</Label>
